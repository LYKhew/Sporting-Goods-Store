...
<head>
  ...
  <title>Sporting Goods Store Ordering System: Orders Details</title>
  <!-- Bootstrap -->
...
<?php include_once 'nav_bar.php'; ?>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a193067_pt2, tbl_staffs_a193067_pt2,
          tbl_customers_a193067_pt2 WHERE
          tbl_orders_a193067_pt2.fld_staff_num = tbl_staffs_a193067_pt2.fld_staff_num AND
          tbl_orders_a193067_pt2.fld_customer_num = tbl_customers_a193067_pt2.fld_customer_num AND
          fld_order_num = :oid");
...
<div class="container-fluid">
  ...
  <td><?php echo $readrow['fld_staff_fullname']; ?></td>
</tr>
<tr>
  <td><strong>Customer</strong></td>
  <td><?php echo $readrow['fld_customer_fullname']; ?></td>
</tr>
  ...
  <button class="btn btn-dark" type="submit" name="addproduct"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Product</button>
  <button class="btn btn-dark" type="reset"><span class="glyphicon glyphicon-erase" aria-hidden="true"></span> Clear</button>
</div>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a193067_pt2,
            tbl_products_a193067_pt2 WHERE
            tbl_orders_details_a193067_pt2.fld_product_num = tbl_products_a193067_pt2.fld_product_num AND
          fld_order_num = :oid");
          $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
          $oid = $_GET['oid'];
        $stmt->execute();
